...
class Settings:
    ...
    registry_timeout_seconds: float = field(default_factory=lambda: float(os.environ.get("VIBECHECK_REGISTRY_TIMEOUT_SECONDS", "5")))
    cache_dir: str = field(default_factory=lambda: os.environ.get("VIBECHECK_CACHE_DIR", ".vibecheck_cache"))
    max_file_bytes: int = field(default_factory=lambda: int(os.environ.get("VIBECHECK_MAX_FILE_BYTES", str(2_000_000))))
